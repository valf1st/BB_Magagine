        ...
        [NSURLConnection sendAsynchronousRequest:request queue:[NSOperationQueue mainQueue] completionHandler:^(NSURLResponse *response, NSData *data, NSError *error) {
            ...
            if (error) {
                ...
                if (error.code == -1003) {
                    ...
                    UIAlertView *alertd = [[UIAlertView alloc] initWithTitle:@"Failed" message:@"No internet connection" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:@"Retry", nil];
                ...
                if (httpStatusCode == 404) {
                    ...
                    UIAlertView *alertd = [[UIAlertView alloc] initWithTitle:@"Error" message:@"Connection failed" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:@"Retry", nil];
                    alertd.alertViewStyle = UIAlertViewStyleDefault;
                    [alertd show];
                    // } else if (・・・) {
